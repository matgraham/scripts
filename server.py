#Python3
#Create a web server that will integrate with any popular Python Framework
#Matt Graham 1/6/17
...
class WSGIServer(object):
    ...
    def handle_one_request(self):
        ...
        #Construct environment dictionary using request_data
    ...
    def start_response(self, status, response_headers, exc_info=None):
        ...
        self.headers_set = [status, response_headers + server_headers]
            #To advere to WSGI specification, the start_response must return a 'write' callable
...
if __name__ == '__main__':
    ...
    print('WSGI: Serving HTTP on port {port} ...\n'.format(port=PORT))
    httpd.serve_forever()
